...
Route::get('/dashboard', function () {
    return view('careManager.dashboard');
})->name('dashboard');

Route::get('/reportsManagement', function () {
    return view('careManager.reportsManagement');
})->name('reportsManagement');

Route::get('/beneficiaryProfile', function () {
    return view('careManager.beneficiaryProfile');
...
Route::get('/familyProfile', function () {
    return view('careManager.familyProfile');
})->name('familyProfile');
...
Route::get('/caregiverProfile', function () {
    return view('careManager.careWorkerProfile');
...
Route::get('/careManagerProfile', function () {
    return view('careManager.careManagerProfile');

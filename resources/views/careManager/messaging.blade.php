            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="newConversationForm" action="{{ route('care-manager.messaging.create') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                    ...
                    <form id="newGroupForm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="alert alert-warning">
                                ...
                                <strong>Important:</strong> You cannot create a group that includes both Administrators and Care Workers.
                            </div>
                            <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <form id="addMemberForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-warning">
                            <i class="bi bi-exclamation-triangle-fill me-2"></i>
                            <strong>Important:</strong> You cannot add Care Workers to a group that has Administrators, or Administrators to a group that has Care Workers.

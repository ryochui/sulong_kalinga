                ...
                <div class="col-12">
                        ...
                        <div class="col-md-4 mb-2">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <h2 class="text-primary" style="font-size: clamp(1.5rem, 2vw, 2rem);">{{ $totalCareHours }} hrs</h2>
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active">
                                                <div class="text-center py-3">
                                                    <p>Detailed care services data will be displayed here</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5 class="mb-0" style="font-size: clamp(1rem, 1.5vw, 1.2rem);">Performance Details</h5>
                                </div>
                                <div class="card-body">
                                    <p class="text-center">Additional performance details will be displayed here</p>
                                </div>
                            </div>
                        </div>
                    </div>

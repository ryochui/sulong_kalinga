                ...
                <div class="col-12">
                    ...
                    <form action="{{ route('admin.beneficiaries.update', $beneficiary->beneficiary_id) }}" method="POST" enctype="multipart/form-data" id="beneficiaryForm">
                        ...
                        <div class="row mb-2 align-items-center">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control" id="mobilityFrequency" name="frequency[mobility]" placeholder="Frequency" rows="2">{{ $careNeeds[1]['frequency'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <textarea class="form-control" id="mobilityAssistance" name="assistance[mobility]" placeholder="Assistance Required" rows="2">{{ $careNeeds[1]['assistance'] ?? '' }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control" id="cognitiveFrequency" name="frequency[cognitive]" placeholder="Frequency" rows="2">{{ $careNeeds[2]['frequency'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <textarea class="form-control" id="cognitiveAssistance" name="assistance[cognitive]" placeholder="Assistance Required" rows="2">{{ $careNeeds[2]['assistance'] ?? '' }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control" id="selfSustainabilityFrequency" name="frequency[self_sustainability]" placeholder="Frequency" rows="2">{{ $careNeeds[3]['frequency'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <textarea class="form-control" id="selfSustainabilityAssistance" name="assistance[self_sustainability]" placeholder="Assistance Required" rows="2">{{ $careNeeds[3]['assistance'] ?? '' }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control" id="diseaseFrequency" name="frequency[disease]" placeholder="Frequency" rows="2">{{ $careNeeds[4]['frequency'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <textarea class="form-control" id="diseaseAssistance" name="assistance[disease]" placeholder="Assistance Required" rows="2">{{ $careNeeds[4]['assistance'] ?? '' }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control" id="dailyLifeFrequency" name="frequency[daily_life]" placeholder="Frequency" rows="2">{{ $careNeeds[5]['frequency'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <textarea class="form-control" id="dailyLifeAssistance" name="assistance[daily_life]" placeholder="Assistance Required" rows="2">{{ $careNeeds[5]['assistance'] ?? '' }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control" id="outdoorFrequency" name="frequency[outdoor]" placeholder="Frequency" rows="2">{{ $careNeeds[6]['frequency'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <textarea class="form-control" id="outdoorAssistance" name="assistance[outdoor]" placeholder="Assistance Required" rows="2">{{ $careNeeds[6]['assistance'] ?? '' }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control" id="householdFrequency" name="frequency[household]" placeholder="Frequency" rows="2">{{ $careNeeds[7]['frequency'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <textarea class="form-control" id="householdAssistance" name="assistance[household]" placeholder="Assistance Required" rows="2">{{ $careNeeds[7]['assistance'] ?? '' }}</textarea>                            </div>
                        </div>
                       ...
                       <!-- Medication Management -->
                        ...
                        <div id="medicationManagement">
                            @if($beneficiary->generalCarePlan && $beneficiary->generalCarePlan->medications->count() > 0)
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="walkingAbility" name="mobility[walking_ability]" 
                                        ...
                                        pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                        title="Only letters, numbers, spaces, commas, periods, hyphens, and parentheses are allowed.">{{ $beneficiary->generalCarePlan->mobility->walking_ability ?? '' }}</textarea>
                                </div>
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="assistiveDevices" name="mobility[assistive_devices]" 
                                        ...
                                        pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                        title="Only letters, numbers, spaces, commas, periods, hyphens, and parentheses are allowed.">{{ $beneficiary->generalCarePlan->mobility->assistive_devices ?? '' }}</textarea>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="transportationNeeds" name="mobility[transportation_needs]" 
                                        ...
                                        pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                        title="Only letters, numbers, spaces, commas, periods, hyphens, and parentheses are allowed.">{{ $beneficiary->generalCarePlan->mobility->transportation_needs ?? '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="memory" name="cognitive[memory]" 
                                        ...
                                        pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                        title="Only letters, numbers, spaces, commas, periods, hyphens, and parentheses are allowed.">{{ $beneficiary->generalCarePlan->cognitiveFunction->memory ?? '' }}</textarea>
                                </div>
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="thinkingSkills" name="cognitive[thinking_skills]" 
                                        ...
                                        pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                        title="Only letters, numbers, spaces, commas, periods, hyphens, and parentheses are allowed.">{{ $beneficiary->generalCarePlan->cognitiveFunction->thinking_skills ?? '' }}</textarea>
                                </div>
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="orientation" name="cognitive[orientation]" 
                                        ...
                                        pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                        title="Only letters, numbers, spaces, commas, periods, hyphens, and parentheses are allowed.">{{ $beneficiary->generalCarePlan->cognitiveFunction->orientation ?? '' }}</textarea>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="behavior" name="cognitive[behavior]" 
                                        ...
                                        pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                        title="Only letters, numbers, spaces, commas, periods, hyphens, and parentheses are allowed.">{{ $beneficiary->generalCarePlan->cognitiveFunction->behavior ?? '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="mood" name="emotional[mood]" 
                                        ...
                                        pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                        title="Only letters, numbers, spaces, commas, periods, hyphens, and parentheses are allowed.">{{ $beneficiary->generalCarePlan->emotionalWellbeing->mood ?? '' }}</textarea>
                                </div>
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="socialInteractions" name="emotional[social_interactions]" 
                                        ...
                                        pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                        title="Only letters, numbers, spaces, commas, periods, hyphens, and parentheses are allowed.">{{ $beneficiary->generalCarePlan->emotionalWellbeing->social_interactions ?? '' }}</textarea>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="emotionalSupport" name="emotional[emotional_support]" 
                                        ...
                                        pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                        title="Only letters, numbers, spaces, commas, periods, hyphens, and parentheses are allowed.">{{ $beneficiary->generalCarePlan->emotionalWellbeing->emotional_support_needs ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="contactName" name="emergency_contact[name]" 
                                    value="{{ $beneficiary->emergency_contact_name }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="relation" name="emergency_contact[relation]" required>
                                    ...
                                    <option value="Parent" {{ $beneficiary->emergency_contact_relation == 'Parent' ? 'selected' : '' }}>Parent</option>
                                    <option value="Sibling" {{ $beneficiary->emergency_contact_relation == 'Sibling' ? 'selected' : '' }}>Sibling</option>
                                    <option value="Spouse" {{ $beneficiary->emergency_contact_relation == 'Spouse' ? 'selected' : '' }}>Spouse</option>
                                    <option value="Child" {{ $beneficiary->emergency_contact_relation == 'Child' ? 'selected' : '' }}>Child</option>
                                    <option value="Relative" {{ $beneficiary->emergency_contact_relation == 'Relative' ? 'selected' : '' }}>Relative</option>
                                    <option value="Friend" {{ $beneficiary->emergency_contact_relation == 'Friend' ? 'selected' : '' }}>Friend</option>
                                    <option value="Other" {{ $beneficiary->emergency_contact_relation == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="emergencyMobileNumber" name="emergency_contact[mobile]" 
                                        value="{{ str_replace('+63', '', $beneficiary->emergency_contact_mobile) }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="email" class="form-control" id="emailAddress" name="emergency_contact[email]" 
                                    value="{{ $beneficiary->emergency_contact_email }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="emergencyProcedures" name="emergency_plan[procedures]" 
                                    ...
                                    required 
                                    pattern="^[A-Za-z0-9\s.,\-()'\"+'!?]+$"!?]+$" 
                                    title="Only letters, numbers, spaces, commas, periods, hyphens, parentheses, single quotes, double quotes, apostrophes, and exclamation/question marks are allowed.">{{ $beneficiary->emergency_procedure }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="careworkerName" name="care_worker[careworker_id]" required>
                                    ...
                                    @foreach ($careWorkers as $careWorker)
                                        <option value="{{ $careWorker->id }}" {{ $currentCareWorker == $careWorker->id ? 'selected' : '' }}>
                                            {{ $careWorker->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-5">
                                ...
                                @forelse($currentCareWorkerTasks as $task)
   ...
   <script>
    ...
    <script>
        ...
        function updateBarangays() {
            ...
            // Store the beneficiary's barangay ID
            const beneficiaryBarangayId = {{ $beneficiary->barangay_id }};
            ...
            @foreach ($barangays as $b)
                if ({{ $b->municipality_id }} == selectedMunicipalityId) {
                    ...
                    // Select this option if it matches the beneficiary's barangay
                    if ({{ $b->barangay_id }} == beneficiaryBarangayId) {

...
<body>
    ...
    <div class="home-section">
        <div class="text-left">CAREGIVER PROFILES</div>
        ...
        <div class="row mb-3">
                <div class="col-md-7">
                    ...
                    <input type="text" class="form-control" placeholder="Search caregiver profile..." id="searchBar">
                    </div>
                </div>
                ...
                <div class="col-md-5 text-end">
                    <div class="d-inline-block me-2">
                        ...
                        <select class="form-select" id="filterDropdown">
                            ...
                            <option value="author">Municipality</option>
                            <option value="type">Barangay</option>
                            <option value="type">Alphabetically</option>
                        </select>
                        </div>
                    </div>
                    <div class="d-inline-block" style="transform: translateY(-3px);">
                        ...
                        <button class="btn btn-primary" id="addReportButton">
                            <i class="bx bx-plus"></i> Add Caregiver
                        </button>
                    </div>
                </div>
            </div>
